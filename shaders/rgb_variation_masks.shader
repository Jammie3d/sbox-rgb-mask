...
PS
{
	...
	bool g_bRedUseAlbedo < UiGroup( "Red Channel,2/,0/6" ); Default( 1 ); >;
	...
	bool g_bGreenUseAlbedo < UiGroup( "Green Channel,3/,0/6" ); Default( 1 ); >;
	...
	bool g_bBlueUseAlbedo < UiGroup( "Blue Channel,4/,0/6" ); Default( 1 ); >;
	bool g_bRedUseNormal < UiGroup( "Red Channel,2/,0/10" ); Default( 0 ); >;
	bool g_bGreenUseNormal < UiGroup( "Green Channel,3/,0/10" ); Default( 0 ); >;
	bool g_bBlueUseNormal < UiGroup( "Blue Channel,4/,0/10" ); Default( 0 ); >;
	bool g_bRedUseRoughness < UiGroup( "Red Channel,2/,0/8" ); Default( 0 ); >;
	bool g_bGreenUseRoughness < UiGroup( "Green Channel,3/,0/8" ); Default( 0 ); >;
	bool g_bBlueUseRoughness < UiGroup( "Blue Channel,4/,0/8" ); Default( 0 ); >;
	bool g_bRedUseMetallic < UiGroup( "Red Channel,2/,0/9" ); Default( 0 ); >;
	bool g_bGreenUseMetallic < UiGroup( "Green Channel,3/,0/9" ); Default( 0 ); >;
	bool g_bBlueUseMetallic < UiGroup( "Blue Channel,4/,0/9" ); Default( 0 ); >;
	bool g_bRedUseAO < UiGroup( "Red Channel,2/,0/7" ); Default( 0 ); >;
	bool g_bGreenUseAO < UiGroup( "Green Channel,3/,0/7" ); Default( 0 ); >;
	bool g_bBlueUseAO < UiGroup( "Blue Channel,4/,0/7" ); Default( 0 ); >;
